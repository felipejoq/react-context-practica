  ...
  return (
    <footer className="text-center mt-5 mb-2 container">
      ...
      <p className="fs-6">
        ...
        <i className="bi bi-github"></i> <a href="https://github.com/felipejoq/react-context-practica" target="_blank" rel="noreferrer" className="text-black text-muted">Repositorio</a>
      </p>
    </footer>
  );
};